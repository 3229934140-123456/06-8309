...
const createTableSQLs = [
  ...
  `CREATE TABLE IF NOT EXISTS appointments (id INTEGER PRIMARY KEY AUTOINCREMENT, patient_id INTEGER NOT NULL, doctor_id INTEGER NOT NULL, slot_id INTEGER NOT NULL, appointment_date TEXT NOT NULL, appointment_no TEXT, status TEXT DEFAULT 'pending', created_at TEXT DEFAULT (datetime('now')))`,
